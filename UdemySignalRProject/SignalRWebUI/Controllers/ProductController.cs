...
namespace SignalRWebUI.Controllers
{
	public class ProductController : Controller
	{
		...
		public async Task<IActionResult> Index()
		{
			...
			var responseMessage = await client.GetAsync("https://localhost:7026/api/Product/ProductListWithCategory");
		...
		public async Task<IActionResult> UpdateProduct(int id)
		{
			...
			var responseMessage1 = await client1.GetAsync("https://localhost:7026/api/Category");
		...
		public async Task<IActionResult> UpdateProduct(UpdateProductDto updateProductDto)
		{
			...
			StringContent stringContent = new StringContent(jsonData, Encoding.UTF8, "application/json");
			var responseMessage = await client.PutAsync("https://localhost:7026/api/Product/", stringContent);
